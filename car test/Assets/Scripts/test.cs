...
public class test : MonoBehaviour
{
    ...
    public Rigidbody sphereRB1;
    public Rigidbody sphereRB2;
    public Rigidbody sphereRB3;
    public Rigidbody sphereRB4;
    ...
    void Start()
    {
        ...
        sphereRB1.transform.parent = null;
        sphereRB2.transform.parent = null;
        sphereRB3.transform.parent = null;
        sphereRB4.transform.parent = null;
        currentSpeed = 0f;
        currentTurnSpeed = 0f;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            sphereRB1.drag = isCarGrounded ? groundDrag : airDrag;
            sphereRB2.drag = isCarGrounded ? groundDrag : airDrag;
            sphereRB3.drag = isCarGrounded ? groundDrag : airDrag;
            sphereRB4.drag = isCarGrounded ? groundDrag : airDrag;
    ...
    private void FixedUpdate()
    {
        if (isCarGrounded)
        {
            ...
            sphereRB1.AddForce(transform.forward * currentSpeed, ForceMode.Acceleration);
            sphereRB2.AddForce(transform.forward * currentSpeed, ForceMode.Acceleration);
            sphereRB3.AddForce(transform.forward * currentSpeed, ForceMode.Acceleration);
            sphereRB4.AddForce(transform.forward * currentSpeed, ForceMode.Acceleration);
        }
        else
        {
            // Apply downward force when in the air
            sphereRB1.AddForce(transform.up * dForce);
            sphereRB2.AddForce(transform.up * dForce);
            sphereRB3.AddForce(transform.up * dForce);
            sphereRB4.AddForce(transform.up * dForce);
        }
    }
